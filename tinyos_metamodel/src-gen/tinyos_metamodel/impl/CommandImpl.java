 ...
 * </p>
 * <ul>
 *   <li>{@link tinyos_metamodel.impl.CommandImpl#getName <em>Name</em>}</li>
 *   <li>{@link tinyos_metamodel.impl.CommandImpl#getHasTask <em>Has Task</em>}</li>
 *   <li>{@link tinyos_metamodel.impl.CommandImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommandImpl extends MinimalEObjectImpl.Container implements Command {
	...
	protected EClass eStaticClass() {
		return Tinyos_metamodelPackage.Literals.COMMAND;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tinyos_metamodelPackage.COMMAND__NAME, oldName,
					name));
	}
	...
	public EList<Task> getHasTask() {
		if (hasTask == null) {
			hasTask = new EObjectContainmentEList<Task>(Task.class, this, Tinyos_metamodelPackage.COMMAND__HAS_TASK);
		}
		return hasTask;
	}
	...
	public void setContents(String newContents) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tinyos_metamodelPackage.COMMAND__CONTENTS,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Tinyos_metamodelPackage.COMMAND__HAS_TASK:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Tinyos_metamodelPackage.COMMAND__NAME:
			return getName();
		case Tinyos_metamodelPackage.COMMAND__HAS_TASK:
			return getHasTask();
		case Tinyos_metamodelPackage.COMMAND__CONTENTS:
			return getContents();
		}
