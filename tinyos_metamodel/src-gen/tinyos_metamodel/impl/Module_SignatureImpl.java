...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Module Signature</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link tinyos_metamodel.impl.Module_SignatureImpl#getUsesInterface <em>Uses Interface</em>}</li>
 *   <li>{@link tinyos_metamodel.impl.Module_SignatureImpl#getProvidesInterface <em>Provides Interface</em>}</li>
 *   <li>{@link tinyos_metamodel.impl.Module_SignatureImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Module_SignatureImpl extends MinimalEObjectImpl.Container implements Module_Signature {
	/**
	 ...
	 * @generated
	 */
	protected Module_SignatureImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Tinyos_metamodelPackage.Literals.MODULE_SIGNATURE;
	}
	...
	public EList<Interface> getUsesInterface() {
		if (usesInterface == null) {
			usesInterface = new EObjectContainmentEList<Interface>(Interface.class, this,
					Tinyos_metamodelPackage.MODULE_SIGNATURE__USES_INTERFACE);
		}
	...
	public EList<Interface> getProvidesInterface() {
		if (providesInterface == null) {
			providesInterface = new EObjectContainmentEList<Interface>(Interface.class, this,
					Tinyos_metamodelPackage.MODULE_SIGNATURE__PROVIDES_INTERFACE);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tinyos_metamodelPackage.MODULE_SIGNATURE__NAME,
					oldName, name));
	}
