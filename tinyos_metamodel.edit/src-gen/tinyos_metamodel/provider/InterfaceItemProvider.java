...
/**
 * This is the item provider adapter for a {@link tinyos_metamodel.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends ItemProviderAdapter
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Interface_Name_feature",
								"_UI_Interface_type"),
						Tinyos_metamodelPackage.Literals.INTERFACE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Tinyos_metamodelPackage.Literals.INTERFACE__HAS_FUNCTION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case Tinyos_metamodelPackage.INTERFACE__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case Tinyos_metamodelPackage.INTERFACE__HAS_FUNCTION:
